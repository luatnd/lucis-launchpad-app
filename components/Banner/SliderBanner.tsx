      ...
      <div className='simple-slider'>
        <Slider {...settings}>
          {listBanner.map((e, i) => (
            <ItemSliderBanner
              key='i'
              setStatusGame={e.setStatusGame}
              setTimeGame={e.setTimeGame}
              setLogoGame={e.setLogoGame}
              setTextGame={e.setTextGame}
              setSrcMore={e.setSrcMore}
              setSrcApply={e.setSrcApply}
            />
          ))}
        </Slider>
      </div>
