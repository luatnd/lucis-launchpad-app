...
export function Lights() {
  return (
    <>
      <spotLight color="#B73FE6" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#9A5CE3" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#7680E0" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#5B9BDE" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#48AEDC" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#33C3DA" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
